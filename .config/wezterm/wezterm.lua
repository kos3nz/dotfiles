...
return {
	...
	keys = {
		...
		{ key = "<", mods = "CMD|SHIFT", action = action({ SendString = "\x11P" }) },
		{ key = ">", mods = "CMD|SHIFT", action = action({ SendString = "\x11N" }) },
		{ key = "{", mods = "CMD|SHIFT", action = action({ SendString = "\x11[" }) },
		{ key = "}", mods = "CMD|SHIFT", action = action({ SendString = "\x11]" }) },
		...
		{ key = "j", mods = "CMD", action = action({ SendString = "\x11m" }) },
